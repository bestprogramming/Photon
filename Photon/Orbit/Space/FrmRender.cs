        ...
        private void Bgw_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            Parallel.For(0, count, a =>
            {
                ...
                Parallel.For(a + 1, count, b =>
                {
                    ...
                    {
                        //var deep = Big.One * oiA.Orbit1.W * oiA.Orbit2.W * oiB.Orbit1.W * oiB.Orbit2.W / (Big.One * oiA.Orbit1.N * oiA.Orbit1.N * oiA.Orbit2.N * oiA.Orbit2.N * oiB.Orbit1.N * oiB.Orbit1.N * oiB.Orbit2.N * oiB.Orbit2.N);
                        var deep =
                            Big.One * oiA.Orbit1.W / (oiA.Orbit1.N * oiA.Orbit1.N) + Big.One * oiA.Orbit2.W / (oiA.Orbit2.N * oiA.Orbit2.N) +
                            Big.One * oiB.Orbit1.W / (oiB.Orbit1.N * oiB.Orbit1.N) + Big.One * oiB.Orbit2.W / (oiB.Orbit2.N * oiB.Orbit2.N);
