...
{
    public partial class FrmSphericalScreenVector : Form
    {
        public readonly string Header;

        public FrmSphericalScreenVector()
        {
            InitializeComponent();
            Header = Text;
        }

        private void FrmSphericalScreenVector_Load(object sender, EventArgs e)
        {
        ...
        private void Smi_Click(object sender, EventArgs e)
        {
            if (sender == SmiSave)
            {
                FormSetting.Write(FormSetting.Get(this), $"{nameof(FrmSphericalScreenVector)}.xml");
            }
            else if (sender == SmiLoad)
            {
                var setting = FormSetting.Read($"{nameof(FrmSphericalScreenVector)}.xml");
        ...
        private static void RenderFile(FormSetting setting, string dir, bool openRender = true)
        {
            ...
            {
                var directory = $"Renders-SphericalScreenVector/{dir}";
                Directory.CreateDirectory(directory);
                FormSetting.Write(setting, $"{directory}/{nameof(FrmSphericalScreenVector)}.xml");
