...
{
    public partial class FrmFlatScreen : Form
    {
        public readonly string Header;

        public FrmFlatScreen()
        {
            InitializeComponent();
            Header = Text;
        }

        private void FrmFlatScreen_Load(object sender, EventArgs e)
        {
        ...
        private void Smi_Click(object sender, EventArgs e)
        {
            if (sender == SmiSave)
            {
                FormSetting.Write(FormSetting.Get(this), $"{nameof(FrmFlatScreen)}.xml");
            }
            else if (sender == SmiLoad)
            {
                var setting = FormSetting.Read($"{nameof(FrmFlatScreen)}.xml");
        ...
        private static void RenderFile(FormSetting setting, string dir, bool openRender = true)
        {
            ...
            {
                var directory = $"Renders-FlatScreen/{dir}";
                Directory.CreateDirectory(directory);
                FormSetting.Write(setting, $"{directory}/{nameof(FrmFlatScreen)}.xml");
