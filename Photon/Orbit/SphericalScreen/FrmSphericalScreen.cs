...
{
    public partial class FrmSphericalScreen : Form
    {
        public readonly string Header;

        public FrmSphericalScreen()
        {
            InitializeComponent();
            Header = Text;
        }

        private void FrmSphericalScreen_Load(object sender, EventArgs e)
        {
        ...
        private void Smi_Click(object sender, EventArgs e)
        {
            if (sender == SmiSave)
            {
                FormSetting.Write(FormSetting.Get(this), $"{nameof(FrmSphericalScreen)}.xml");
            }
            else if (sender == SmiLoad)
            {
                var setting = FormSetting.Read($"{nameof(FrmSphericalScreen)}.xml");
        ...
        private static void RenderFile(FormSetting setting, string dir, bool openRender = true)
        {
            ...
            {
                var directory = $"Renders-SphericalScreen/{dir}";
                Directory.CreateDirectory(directory);
                FormSetting.Write(setting, $"{directory}/{nameof(FrmSphericalScreen)}.xml");
