...
{
    public partial class UctCylinder : UserControl, IUctShape
    {
        public UctCylinder()
        {
            InitializeComponent();
        ...
        public override string ToString() => $"Cylinder vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, r={NudR.ToDouble()}, length={NudLength.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            return CylinderSetting.Get(this);
        }
        #endregion
    }
}
