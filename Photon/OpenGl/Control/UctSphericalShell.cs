...
{
    public partial class UctSphericalShell : UserControl, IUctShape
    {
        public UctSphericalShell()
        {
            InitializeComponent();
            SetWeight(16);
        }
        ...
        public override string ToString() => $"Spherical shell vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}{(ChbRotate.Checked ? Urt : "")}, r={NudR.ToDouble()}, count={NudCount.ToInt()}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            return SphericalShellSetting.Get(this);
        }
        #endregion
    }
}
