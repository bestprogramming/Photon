...
{
    public partial class UctLine : UserControl, IUctShape
    {
        public UctLine()
        {
            InitializeComponent();
        ...
        public override string ToString() => $"Line vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x1={NudX1.ToDouble()}, y1={NudY1.ToDouble()}, z1={NudZ1.ToDouble()}, x2={NudX2.ToDouble()}, y2={NudY2.ToDouble()}, z2={NudZ2.ToDouble()}, count={NudCount.ToInt()}, end={ChbEnd.Checked.ToString().ToLower()}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
