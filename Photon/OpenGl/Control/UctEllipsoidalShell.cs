...
{
    public partial class UctEllipsoidalShell : UserControl, IUctShape
    {
        public UctEllipsoidalShell()
        {
            InitializeComponent();
            SetWeight(16);
            ...
            CmbCount.SelectedIndex = CmbCount.Items.IndexOf(2048);
        }
        ...
        public override string ToString() => $"Ellipsoidal shell vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, a={NudA.ToDouble()}, b={NudB.ToDouble()}, c={NudC.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            var ret = new UctEllipsoidalShell();

            ret.NudX.Value = NudX.Value;
            ret.NudY.Value = NudY.Value;
            ret.NudZ.Value = NudZ.Value;
            ret.NudA.Value = NudA.Value;
            ret.NudB.Value = NudB.Value;
            ret.NudC.Value = NudC.Value;
        ...
        {
            return EllipsoidalShellSetting.Get(this);
        }
        #endregion
    }
}
