...
{
    public partial class UctCircle : UserControl, IUctShape
    {
        public UctCircle()
        {
            InitializeComponent();
        ...
        public override string ToString() => $"Circle vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}{(ChbRotate.Checked ? Urt : "")}, r={NudR.ToDouble()}, count={NudCount.ToInt()}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
