...
{
    public partial class UctCylindricalShell : UserControl, IUctShape
    {
        public UctCylindricalShell()
        {
            InitializeComponent();
            SetWeight(16);
            ...
            CmbCount.SelectedIndex = CmbCount.Items.IndexOf(13500);
        }
        ...
        public override string ToString() => $"Cylindrical shell vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, r={NudR.ToDouble()}, length={NudLength.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        private void ChbRotate_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else if (ChbRotate.Checked)
            {
                ...
                Urt.NudAngle.FromDouble(Const.PiOver2);
                Urt.NudY2.FromDouble(1.0);
            }
        }
        ...
        {
            var ret = new UctCylindricalShell();
        ...
        {
            return CylindricalShellSetting.Get(this);
        }
        #endregion
    }
}
