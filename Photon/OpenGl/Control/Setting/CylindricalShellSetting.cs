...
{
    public class CylindricalShellSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static CylindricalShellSetting Get(UctCylindricalShell uct)
        {
            var ret = new CylindricalShellSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
        ...
        {
            var uct = (UctCylindricalShell)uctShape;
        ...
        {
            return new CylindricalShell(X, Y, Z, R, Length, Convert.ToInt32(Count), FrmWeight.ToVec4(Weight), 2);
        }
