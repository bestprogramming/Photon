...
{
    public class EllipsoidSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static EllipsoidSetting Get(UctEllipsoid uct)
        {
            var ret = new EllipsoidSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
        ...
        {
            return new Ellipsoid(X, Y, Z, A, B, C, Convert.ToInt32(Count), FrmWeight.ToVec4(Weight), 2);
        }
