...
{
    public class SpheroidSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static SpheroidSetting Get(UctSpheroid uct)
        {
            var ret = new SpheroidSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
        ...
        {
            return new Spheroid(X, Y, Z, A, C, Convert.ToInt32(Count), FrmWeight.ToVec4(Weight), 2);
        }
