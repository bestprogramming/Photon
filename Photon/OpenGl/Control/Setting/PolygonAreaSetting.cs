...
{
    public class PolygonAreaSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static PolygonAreaSetting Get(UctPolygonArea uct)
        {
            var ret = new PolygonAreaSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
        ...
        {
            var uct = (UctPolygonArea)uctShape;
        ...
        {
            return new PolygonArea(X, Y, Z, R, EdgesCount, Convert.ToInt32(PointsCount), From, To, End, FrmWeight.ToVec4(Weight), 2);
        }
