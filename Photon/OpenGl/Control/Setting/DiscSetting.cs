...
{
    public class DiscSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static DiscSetting Get(UctDisc uct)
        {
            var ret = new DiscSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
        ...
        {
            return new Disc(X, Y, Z, R, Convert.ToInt32(Count), FrmWeight.ToVec4(Weight), 2);
        }
