...
{
    public class PolygonPrismSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static PolygonPrismSetting Get(UctPolygonPrism uct)
        {
            var ret = new PolygonPrismSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
                ...
                PointsCount = uct.CmbPointsCount.Text,
        ...
        {
            var uct = (UctPolygonPrism)uctShape;
            ...
            uct.CmbPointsCount.Text = PointsCount;
        ...
        {
            return new PolygonPrism(X, Y, Z, R, EdgesCount, Length, Convert.ToInt32(PointsCount), From, To, End, FrmWeight.ToVec4(Weight), 2);
        }
