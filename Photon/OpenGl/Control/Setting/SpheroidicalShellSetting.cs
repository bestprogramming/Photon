...
{
    public class SpheroidicalShellSetting : BaseSetting
    {
        public double X;
        public double Y;
        public double Z;
        ...
        public static SpheroidicalShellSetting Get(UctSpheroidicalShell uct)
        {
            var ret = new SpheroidicalShellSetting
            {
                X = uct.NudX.ToDouble(),
                Y = uct.NudY.ToDouble(),
                Z = uct.NudZ.ToDouble(),
        ...
        {
            var uct = (UctSpheroidicalShell)uctShape;
        ...
        {
            return new SpheroidicalShell(X, Y, Z, A, C, Convert.ToInt32(Count), FrmWeight.ToVec4(Weight), 2);
        }
