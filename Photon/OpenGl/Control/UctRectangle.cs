...
{
    public partial class UctRectangle : UserControl, IUctShape
    {
        public UctRectangle()
        {
            InitializeComponent();
        ...
        public override string ToString() => $"Rectangle vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, width={NudWidth.ToDouble()}, height={NudHeight.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            return RectangleSetting.Get(this);
        }
        #endregion
    }
}
