...
{
    public partial class UctPolygonPrism : UserControl, IUctShape
    {
        public UctPolygonPrism()
        {
            InitializeComponent();
            SetWeight(16);

            LblPointsCount.MouseEnter += Tooltip_SpheresInACube_MouseEnter;
            ...
            CmbPointsCount.SelectedIndex = CmbPointsCount.Items.IndexOf(4631);
        }
        ...
        public override string ToString() => $"PolygonPrism vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}{(ChbRotate.Checked ? Urt : "")}, r={NudR.ToDouble()}, count={NudEdgesCount.ToInt()}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            return PolygonPrismSetting.Get(this);
        }
        #endregion
    }
}
