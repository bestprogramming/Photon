...
{
    public partial class UctPoint : UserControl, IUctShape
    {
        public UctPoint()
        {
            InitializeComponent();
        ...
        public override string ToString() => $"Point vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
