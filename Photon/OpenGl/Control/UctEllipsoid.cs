...
{
    public partial class UctEllipsoid : UserControl, IUctShape
    {
        public UctEllipsoid()
        {
            InitializeComponent();
            ...
            CmbCount.SelectedIndex = CmbCount.Items.IndexOf(5808);
        }
        ...
        public override string ToString() => $"Ellipsoid vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, a={NudA.ToDouble()}, b={NudB.ToDouble()}, c={NudC.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            return EllipsoidSetting.Get(this);
        }
        #endregion
    }
}
