...
{
    public partial class UctSpheroidicalShell : UserControl, IUctShape
    {
        public UctSpheroidicalShell()
        {
            InitializeComponent();
            SetWeight(16);
            ...
            CmbCount.SelectedIndex = CmbCount.Items.IndexOf(800);
        }
        ...
        public override string ToString() => $"Spheroidical shell vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, a={NudA.ToDouble()}, c={NudC.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            var ret = new UctSpheroidicalShell();
        ...
        {
            return SpheroidicalShellSetting.Get(this);
        }
        #endregion
    }
}
