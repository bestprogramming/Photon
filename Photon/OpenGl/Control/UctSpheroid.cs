...
{
    public partial class UctSpheroid : UserControl, IUctShape
    {
        public UctSpheroid()
        {
            InitializeComponent();
            ...
            CmbCount.SelectedIndex = CmbCount.Items.IndexOf(2916);
        }
        ...
        public override string ToString() => $"Spheroid vertices:{Write(true, true, true)} weight={PnlWeight.Tag}, x={NudX.ToDouble()}, y={NudY.ToDouble()}, z={NudZ.ToDouble()}, a={NudA.ToDouble()}, c={NudC.ToDouble()}, count={CmbCount.Text}{(ChbRotate.Checked ? Urt : "")}{(ChbCloneVibrate.Checked ? Ucv : "")}{(ChbOrbitVibrate.Checked ? Uov : "")}";
        ...
        {
            return SpheroidSetting.Get(this);
        }
        #endregion
    }
}
