...
{
    public class Spheroid : Shape
    {
        public Spheroid(double x, double y, double z, double a, double c, int countSpheresInCube, Vec4 color, double pointSize = 1)
        {
            ...
            {
                if (Compare.Lte((center.X * center.X + center.Y * center.Y) / a2 + center.Z * center.Z / c2, 1))
                {
