...
{
    public class SpheroidicalShell : Shape
    {
        public SpheroidicalShell(double x, double y, double z, double a, double c, int countSpheresInCube, Vec4 color, double pointSize = 1)
        {
            ...
            {
                if (Compare.Gte((center.X * center.X + center.Y * center.Y) / a2Min + center.Z * center.Z / c2Min, 1) &&
                    Compare.Lte((center.X * center.X + center.Y * center.Y) / a2Max + center.Z * center.Z / c2Max, 1))
                {
