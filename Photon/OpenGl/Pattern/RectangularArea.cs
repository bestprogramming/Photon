...
{
    public class RectangularArea : Shape
    {
        public double Height;

        public RectangularArea(double x, double y, double z, double width, int count, Vec4 color, double pointSize = 1)
        {
            ...
            var cs = Packing.CirclesInARectangle.GetAreaCenters(count);
