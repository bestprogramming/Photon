namespace Photon.TestIntersection
{
    partial class FrmTwoEllipses
    {
        ...
        private void InitializeComponent()
        {
            ...
            flowLayoutPanel2.Size = new Size(1866, 29);
            ...
            NudEx2.TabIndex = 14;
            NudEx2.Value = new decimal(new int[] { 100, 0, 0, 0 });
            ...
            NudEy2.TabIndex = 12;
            NudEy2.Value = new decimal(new int[] { 100, 0, 0, 0 });
            ...
            NudEa2.TabIndex = 16;
            NudEa2.Value = new decimal(new int[] { 300, 0, 0, 0 });
            ...
            NudEb2.TabIndex = 39;
            NudEb2.Value = new decimal(new int[] { 100, 0, 0, 0 });
            ...
            Name = "FrmTwoEllipses";
            Text = "Intersection (TwoEllipses)";
            WindowState = FormWindowState.Maximized;
            Load += FrmTwoEllipses_Load;
